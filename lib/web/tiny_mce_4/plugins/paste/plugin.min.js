    ...
    n && e.selection.setRng(n), dt(t, function (t) {
        !function (t, e) {
            ...
            if (d.src = e.uri, u = t.settings, s = d, !u.images_dataimg_filter || u.images_dataimg_filter(s)) {
                var m, p = t.editorUpload.blobCache, g = void 0;
